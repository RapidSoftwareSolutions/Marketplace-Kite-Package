<?php
$app->post('/api/Kite/orderSublimationApparel', function ($request, $response, $args) {
    ...
    if (!empty($post_data['args']['frontImage'])) {
    ...
    if (!empty($post_data['args']['backImage'])) {
        $post_data['args']['jobs'][0]['assets']['back_image'] = $post_data['args']['backImage'];
    }
