<?php
$app->post('/api/Kite/orderPhoneCase', function ($request, $response, $args) {
    ...
    if (!empty($post_data['args']['caseStyle'])) {
        $post_data['args']['jobs'][0]['options']['case_style'] = $post_data['args']['caseStyle'];
    }
